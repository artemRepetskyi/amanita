...
<head>
  ...
  <meta name="description"
    content="Купить красных сушеных мухоморов Amanita muscaria по всей Украине. Киев, Одесса, Днепр, Харьков. ">
...
<body>
  <div id="wrapper">
    ...
    <!-- Header -->
    <header id="header" class="s-header bg-cover bg-fixed"
      style="background-image: url(images/views/sections/s-header/bg.jpg); ;">
    ...
    <section id="about-us" class="pt-7">
      <div class="container d-flex flex-column align-items-center">
        ...
        <div class="js-opacity-texts-1 text-3">
          <p class="item-1 mb-7">Добро пожаловать в наш интернет магазин . Здесь вы можете приобрести мухомор красный
            Amanita Miscaria в разных видах. Мы сами собираем плодовые тела в течении летне-осеннего периода. Собираются
            они на диком полуострове на територии Украины, где нету ни машин, ни дорог, практически нет людей и нет
            цивилизации. Собираются только шляпки, без признаков червивости или гниения. Шляпки аккуратно складываются в
            коробку пластинками вниз чтобы не попадал песок. Шляпки мы срезаем деревянным ножом чтобы в гриб не попадал
            метал. Когда грибы собраны, мы их перебираем, очищаем и затем перемещаем в специальную сушилку. Там они
            сушаться при температуре 35-40 градусов. После того как шляпки высушились, мы кладем их в герметизируемые
            пакеты, откачиваем воздух и кладем в прохладное, сухое, темное помещение на 2 месяца. Только после этих
            пройденных этапов, они поступают в продажу на нашем сайте. Наши шляпки имеют отличный ярко красный цвет,
            сильный запах и хороший вкус. </p>
          <p class="item-2 mb-7"> Наш приоритет - иметь лучший продукт, рассказывать людям о мухоморе Amanita Muscaria и
            помогать тем, кому нужна помощь с этим натуральным средством.
          </p>
          ...
          <div class="swiper-container gallery-top">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide"><a data-fancybox="gallery"
                  href="images/views/sections/section-2/gallery-<?= $i ?>.<?= $type ?>"
                  data-options='{"backFocus":false}'><img class="swiper-lazy"
                    data-src="images/views/sections/section-2/gallery-<?= $i ?>.<?= $type ?>" alt="">
      ...
      <div class="container">
        ...
        <div class="row justify-content-between">
          ...
          <div class="js-product col-lg-5 py-5 col-12">
            ...
            <p class="text-3 font-500 mb-4">350 грн / 920 руб</p>
            <a href="" data-id="0" data-price="350" class="js-add-to-cart c-btn c-btn--width c-btn--spacing">КУПИТЬ</a>
          </div>
          <!-- Product 1 -->
          <div class="js-product col-lg-5 py-5 col-12">
            <div class="c-image mb-3">
            ...
            <p class="text-3 font-500 mb-4">650 грн / 1700 руб</p>
            <a href="" data-id="1" data-price="650" class="js-add-to-cart c-btn c-btn--width c-btn--spacing">КУПИТЬ</a>
          </div>
          <!-- Product 2 -->
          <div class="js-product col-lg-5 py-5 col-12">
            <div class="c-image mb-3">
            ...
            <p class="text-3 font-500 mb-4">3100 грн / 8100 руб</p>
            <a href="" data-id="2" data-price="3100" class="js-add-to-cart c-btn c-btn--width c-btn--spacing">КУПИТЬ</a>
          </div>
          <!-- Product 2 -->
          <div class="js-product col-lg-5 py-5 col-12">
            <div class="c-image mb-3">
            ...
            <p class="text-3 font-500 mb-4">400 грн / 1050 руб</p>
            <a href="" data-id="3" data-price="400" class="js-add-to-cart c-btn c-btn--width c-btn--spacing">КУПИТЬ</a>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 col-12 mb-lg-0 mb-7">
            <iframe style="width: 100%; height: 260px;" src="https://www.youtube-nocookie.com/embed/oHpIds4Timw"
              frameborder="0"
    ...
    <section id="" class="pt-7 pb-7">
      <div class="container">
        ...
        <p class="text-3 font-300 mb-4">
          ...
          <br>Также если Вы из г. Одесса, можно забрать самовывозом.
          <br>Оплата на територии Украины: либо оплатой на карту либо наложенным платежом без предоплаты
          <br>Оплата в другие страны: По полной предоплате + оплата за доставку
        </p>
        <p class="font-500 text-3">Также, если Вы хотите проверить наш продукт, мы можем бесплатно отправить Вам одну
          шляпку красного мухомора ( доставка за ваш счет).</p>
      </div>
    </section>
        ...
        <div class="row justify-content-between">
          <div class="col-md-auto col-12  mb-7">
            <ul class="text-0">
              ...
              <li>
                <p><span class="color-zero">Телефон:</span> <a class="color-default" href="tel:+380930333821">+380 93
                    033 38 21</a></p>
              </li>
              <li>
                <p><span class="color-zero">Email:</span> <a href="mailto:muhomorfamily@gmail.com"
                    class="color-default">muhomorfamily@gmail.com</a></p>
              </li>
              <li>
          ...
          <div class="col-md-auto col-1lg-2 col-12">
            <ul>
              <li class="mb-5">
                <a target="_blank" class="d-flex align-items-center color-default text-0"
              ...
              <li>
                <a target="_blank" class="d-flex align-items-center color-default text-0"
                  href="https://teleg.run/phapha_agaric">
  ...
  <div id="c-modal_checkout" class="c-modal c-modal--width p-5" style="display: none;">
    ...
    <form action="" class="js-form">
      ...
      <label class="d-block mb-4 text-5">Если вы желаете чтобы мы вам уже отправили без предварительного звонка,
        напишите ниже ФИО получателя, город, склад новой почты и телефон</label>
